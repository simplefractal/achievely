...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feed_post', (
            ...
            ('video_url', self.gf('django.db.models.fields.URLField')(max_length=400, null=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('feed', ['Post'])

    def backwards(self, orm):
        # Deleting model 'Post'
        db.delete_table('feed_post')
    ...
    models = {
        ...
        'feed.post': {
            ...
            'video_url': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True'})
        }
    }
