...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feed_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Post'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('feed', ['Comment'])

    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('feed_comment')
    ...
    models = {
        ...
        'feed.comment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Post']"}),
